...
const INTRO_SLIDES = [
  ...
  },
  {
    title: "Зимородок",
    text: [
      "Я много лет я писал работы в стол. Но однажды решился показать свои тексты, и ни на секунду об этом не пожалел.",
      ...
      "Потому что мне всегда недоставало интерактива в работах. И я решил поэкспериментировать и создать вот такой бонус."
    ]
  },
  {
    title: "Кругоявь",
    text: [
      ...
      "Я хочу продолжать делать работу 'Зимородок' интерактивной и насыщенной дополнительным контентом, поэтому буду безумно рад любым вашим идеям о том, как дополнить и усовершенствовать игру, критике и просто словам поддержки.",
